...
+ **Qinghe Ma**, Zhen Zhao, Yiming Wu, Jian Zhang, LEI BAI, Yinghuan Shi. [Are Tools Always Beneficial? Learning to Invoke Tools Adaptively for Dual-Mode Multimodal LLM Reasoning.](https://arxiv.org/pdf/2605.19852) Forty-Third International Conference on Machine Learning (*ICML*), 2026.
...
+ **Qinghe Ma**, Jian Zhang, Zekun Li, Lei Qi, Qian Yu, Yinghuan Shi. [Steady Progress Beats Stagnation: Mutual Aid of Foundation and Conventional Models in Mixed Domain Semi-Supervised Medical Image Segmentation.](https://openaccess.thecvf.com/content/CVPR2025/html/Ma_Steady_Progress_Beats_Stagnation_Mutual_Aid_of_Foundation_and_Conventional_CVPR_2025_paper.html) Conference on Computer Vision and Pattern Recognition (*CVPR*), 2025.
